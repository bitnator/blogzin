                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="{{ asset('site/img/blog/single_blog_1.png') }}" alt="">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="{{ asset('site/img/post/post_1.png') }}" alt="post">
                            ...
                            <div class="media post_item">
                                <img src="{{ asset('site/img/post/post_2.png') }}" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                            ...
                            <div class="media post_item">
                                <img src="{{ asset('site/img/post/post_3.png') }}" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                            ...
                            <div class="media post_item">
                                <img src="{{ asset('site/img/post/post_4.png') }}" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
